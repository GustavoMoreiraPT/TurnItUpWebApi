...
{
    public partial class CustomerUpdateForRegister6 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeaderPhotoId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Customers_Images_HeaderPhotoId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Customers_Images_ProfilePhotoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_HeaderPhotoId",
                table: "Customers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_ProfilePhotoId",
                table: "Customers",
