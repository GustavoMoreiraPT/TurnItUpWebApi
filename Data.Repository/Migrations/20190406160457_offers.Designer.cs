...
namespace Data.Repository.Migrations
{
    ...
    [Migration("20190406160457_offers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.ValueObjects.Gender", b =>
                {
                    ...
                    b.Property<int?>("TurnItUpUserId");

                    b.HasKey("Id");

                    b.HasIndex("TurnItUpUserId");
            ...
            modelBuilder.Entity("Domain.Model.Events.Event", b =>
                {
                    ...
                    b.HasOne("Domain.Model.Recruiter.Recruiter", "Recruiter")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Model.ValueObjects.Gender", b =>
                {
                    b.HasOne("Domain.Model.TurnItUpUser")
                        .WithMany("Genders")
                        .HasForeignKey("TurnItUpUserId");
                });
